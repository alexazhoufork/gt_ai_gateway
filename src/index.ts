...
// 注册资源文件
registerFile([
  { path: 'resource/migrate/migrate_0001.sql', content: migrate_0001 },
  { path: 'resource/migrate/migrate_0002.sql', content: migrate_0002 },
  { path: 'resource/migrate/migrate_0003.sql', content: migrate_0003 },
])
